...
<head>
    <title>Supplier | Warehouse System</title>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Edit Supplier Profile</h5>
                                            <!-- <p class="m-b-0"></p> -->
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="page-body">
                                        <div class="card">
                                            ...
                                            <div class="card-block">
                                                ...
                                                <?php 
                                                $getSupplier = $sl->selectOneMatchSingle('suppliers','id',$supplier);
                                                if ($getSupplier) {
                                                ...
                                                <form>
                                                    ...
                                                    <input type="hidden" name="supplier" value="<?php echo $row['id']; ?>">
                                                    <h4 class="sub-title">Suppier Information</h4>
                                                    <div class="form-group row">
                                                        <label class="col-sm-2 col-form-label">Name <span class="text-danger">*</span></label>
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" name="name" 
                                                            placeholder="Name of Supplier/Organization" value="<?php echo $row['supplier_name']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            ...
                                                            placeholder="Address of Supplier"> <?php echo $row['address']; ?></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                ...
                                                <h4 class="sub-title">Remove Supplier</h4>
                                                <div class="form-group text-center">
                                                    <button type="button" class="btn btn-round btn-grd-danger del-supplier-btn" id="<?php echo $row['id']; ?>">Delete</button>
                                                </div>

                                                <?php 
                                                }else{
                                                    echo '<h4 class="sub-title">Error</h4>
                                                    <h3 class="text-center">Supplier Not Found</h3>';
                                                } ?>
