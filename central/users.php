...
<head>
    <title>Users | Warehouse System </title>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">Control Users Page</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                            ...
                                            <div class="card-block" style="display: none;">
                                                <form>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-auto">
                                                            <label class="radio-inline col-form-label"><input type="radio" value="Male" name="gender"> Male</label>
                                                        </div>
                                                        <div class="col">
                                                            <label class="radio-inline col-form-label"><input type="radio" value="Female" name="gender"> Female</label>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#data-table').DataTable({
                ...
                processing: true,
                // serverSide: true,
                ajax: "../assets/data/datatables-data.php?table=user",
                columns: [
                    { data: 'sn' },
                    { data: 'name' },
                    { data: 'phone' },
            ...
            $(document).on('click', '.view-user', function () {
                ...
                $.ajax({
                    ...
                    data        : {content:"user_profile", id:user}, 
                    dataType    : 'json',
                    encode      : true
                })
                .done(function(data) {
