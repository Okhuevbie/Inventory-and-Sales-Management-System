                                                                        ...
                                                                        <?php 
                                                                            ...
                                                                            if ($getProducts) {
                                                                                while ($row = $getProducts->fetch_assoc()) {
                                                                                    if($row['product_code']==''){
                                                                                        $product =  $row['product_name'] .' (NGN '. number_format($row['unit_price'], 2) .')';
                                                                                    }else{
                                                                                        $product = $row['product_code']. ' : '. $row['product_name'] .' (NGN '. number_format($row['unit_price'], 2) .')';
                                                                                    }
                                                                                    echo '<option value="'. $row['id'] .'">'.$product. '</option>';
                                                                                }
                                                                            }else{
