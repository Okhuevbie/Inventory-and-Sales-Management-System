                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Order Placement</h5>
                                            <!-- <p class="m-b-0"></p> -->
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item"><a href="#">Order Placement</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="page-body">
                                        <div class="card">
                                            ...
                                            <div class="card-block">
                                                <form>
                                                    <input type="hidden" name="action" value="outstanding_order">
                                                    <h4 class="sub-title">Product Destination</h4>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <select class="form-control select2bs4 product" name="product[]" id="product-0" data-row="0" required>
                                                                        ...
                                                                        <?php 
                                                                            $getProducts = $sl->selectProductsForOrder2();
                                                                            if ($getProducts) {
                                                                ...
                                                                <td>
                                                                    <input type="number" class="form-control quantity" id="quantity-0" data-row="0" name="quantity[]" value="1" min="1" required>
                                                                </td>
                                                                <td>
                                                                    <input type="number" class="form-control subtotals" id="subtotal-0" data-row="0" placeholder="0" step="0.01" readonly>
                                                                </td>
        ...
        $(function () {
            ...
            $('#add-product-btn').click(function(){
              ...
              var newRow = '<tr id="row-'+ i +'">'+
                                ...
                                '<td><input type="number" class="form-control quantity" id="quantity-'+ i +'" data-row="'+ i +'" name="quantity[]" value="1" min="1" required></td>'+
                                '<td><input type="number" class="form-control subtotals" id="subtotal-'+ i +'" data-row="'+ i +'" name="subtotal[]" placeholder="0.00" readonly></td>'+
                                '<td><button type="button" class="btn btn-sm btn-danger btn-remove" data-row="'+ i +'" >X</button></td>'+
                            '</tr>';
