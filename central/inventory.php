...
<head>
    <title>Inventory | Warehouse System </title>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            ...
                                            <p class="m-b-0">Inventory Control Page</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="card add-category-card">
                                            ...
                                            <div class="card-block" style="display: none;">
                                                <form id="add-product-form" class="category-form" data-table="category">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" name="category" placeholder="e.g Automobile, Stationary, Structures" required>
                                                        </div>
                                                    </div>
                                        ...
                                        <!-- product card -->
                                        <div class="card add-inventory-card">
                                            <div class="card-header">
                                            ...
                                            <div class="card-block" style="display: none;">
                                                <form id="item-form" data-table="inventory">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="number" class="form-control" name="quantity" placeholder="e.g 10" required min="1">
                                                        </div>
                                                    </div>
                                                    <div class="form-group text-center">
                                                        <button type="submit" class="btn btn-round btn-grd-success">Submit</button>
                                        ...
                                        <!--table card end -->
                                        <!-- table card start -->
                                        <div class="card list-inventory-card">
                                            <div class="card-header">
                                                ...
                                                <div class="card-header-right">
                                                    <ul class="list-unstyled card-option">
                                                        ...
                                                        <li><i class="fa fa-window-maximize full-card"></i></li>
                                                        <li><i class="fa minimize-card fa-minus"></i></li>
                                                        <li><i class="fa fa-sync reload-card" data-table="inventory-table"></i></li>
                                                    </ul>
                              ...
                              <div class="modal-dialog modal-lg  modal-dialog-scrollable">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-header">
                                    <h4 class="modal-title">Inventory Category</h4>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            function getCategories() {
                ...
                $.getJSON('../assets/data/select-data.php?table=inventory_category', function(data){
            ...
            $('#category-table').DataTable({
                ...
                processing: true,
                // serverSide: true,
                ajax: "../assets/data/datatables-data.php?table=inventory_category",
                columns: [
                    { data: 'sn' },
                    { data: 'title' },
                    { data: 'action' }
            ...
            $('#inventory-table').DataTable({
                ...
                processing: true,
                // serverSide: true,
                ajax: "../assets/data/datatables-data.php?table=inventory",
                columns: [
                    { data: 'sn' },
                    { data: 'category' },
                    { data: 'name' },
            ...
            $(document).on('submit', 'form', function(event) {
              ...
              .done(function(data) {
                if (data.success === true) {
                  ...
                  $(".add-"+table+"-card .add-card").click();
                  setTimeout( function () {
                    $(".list-"+table+"-card .reload-card").click();
            ...
            $(document).on('click', '.edit-category', function () {
                ...
                $.ajax({
                    ...
                    data        : {content:"edit_inventory_category", id:category}, 
                    dataType    : 'json',
                    encode      : true
                })
                .done(function(data) {
            ...
            $(document).on('click', '.view-inventory', function () {
                ...
                $.ajax({
                    type        : 'POST',
                    url         : '../assets/data/modal-data.php',
                    data        : {content:"inventory_info", id:inventory}, 
                    dataType    : 'json',
                    encode      : true
                })
                .done(function(data) {
                  if (data.success === true) {
                    $('#inventoryModal .modal-body').html(data.message);

                    var curr_category = $('#select-edit-category').val();
                    $('#select-edit-category').empty();
                    $.getJSON('../assets/data/select-data.php?table=inventory_category&selected='+curr_category, function(data){

                      if (data !== null) {
                        $.each(data, function(key, value){
                            $('#select-edit-category').append(new Option(value.text, value.id, value.selected, value.selected));
                        });
                      }
                    ...
                    $('#inventoryModal .modal-body').html('<div class="text-center m-5"><h4>'+ data.errors +'</h4></div>');
                  }
                })
                .fail(function () {
                    $('#inventoryModal .modal-body').html('<div class="text-center m-5"><h4>Sorry, Could not Establish a connection.</h4></div>');
                });
            ...
            $(document).on('click', '.del-category-btn', function(){
              ...
              swal({
                    title: "Delete !",
                    text: "Are you sure you want to Delete Inventory Category?\n This does not affect associated Items!",
                    type: "warning",
                    showCancelButton: !0,
                  ...
                  $.post('../assets/redirects/delete.php', {id:item_id, tab:'inventory_category', token:'randomKeyWord'}, function (response, status) {
            ...
            $(document).on('click', '.del-inventory-btn', function(){
              var item_id = $(this).attr("id");
              swal({
                    title: "Delete !",
                  ...
                  $.post('../assets/redirects/delete.php', {id:item_id, tab:'inventory', token:'randomKeyWord'}, function (response, status) {
                        var data = JSON.parse(response);
                        if (data.success === true) {
                            swal("Deleted !", data.message, "success");
                            setTimeout( function () {
                              $(".list-inventory-card .reload-card").click();
                            }, 1000);
                        } else {
                            sweetAlert("Oops...", data.errors, "error");
                        }
